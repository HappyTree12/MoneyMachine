...
export class ApiConfigService {
  ...
  get serverUrl() {
    return {
      url: this.getString('SERVER_URL'),
    };
  }

  get web3config() {
    return {
      feeWallet: this.getString('PHANTOM_FEE_WALLET'),
      tokenId: this.getString('MINT_ADDRESS'),
    };
  }

  get telegramBotUsername() {
    return this.getString('TELEGRAM_BOT_USERNAME');
  }
